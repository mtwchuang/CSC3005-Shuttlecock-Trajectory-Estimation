...
def train_random_forest_model(filepath, best_depth, best_n_estimators, outpath):
    """Reusable function to train a Random Forest model."""
    ...
    best_rf_model = RandomForestRegressor(n_estimators=best_n_estimators, max_depth=best_depth, random_state=42)
